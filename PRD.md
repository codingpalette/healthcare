# 🏋️‍♂️ 헬스장 맞춤형 웨스트짐 플랫폼 PRD (Product Requirements Document)

## 1. 프로젝트 개요 (Project Overview)
본 프로젝트는 헬스장 회원과 트레이너를 긴밀하게 연결하여, 회원들의 성공적인 목표 달성을 돕는 웹 기반 웨스트짐 서비스입니다. 회원들은 매일의 식단과 운동을 기록하고 올바른 기구 사용법을 숙지할 수 있으며, 트레이너는 이를 모니터링하고 맞춤형 피드백을 제공하여 퀄리티 높은 PT(Personal Training) 및 회원 관리 경험을 제공합니다.
